...
#!define MUI_FINISHPAGE_RUN $INSTDIR\incrementum-qt.exe
...
OutFile incrementum-0.5.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/incrementum-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/incrementumd.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\incrementum-qt.exe
